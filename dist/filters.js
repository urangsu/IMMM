...
function FilterOverlay({
  ...
  }), /*#__PURE__*/React.createElement("style", null, `@keyframes glitterPulse { from{opacity:0.3;transform:scale(0.7)} to{opacity:1;transform:scale(1.3)} }`));
  if (type === 'purikura') return /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      inset: 0,
      pointerEvents: 'none',
    ...
    d: "M8 0l1.5 6.5L16 8l-6.5 1.5L8 16l-1.5-6.5L0 8l6.5-1.5z",
    fill: "#fff"
  })))));
  if (type === 'blush') return /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      inset: 0,
      pointerEvents: 'none',
...
function PlaceholderPortrait({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      position: 'absolute',
      inset: 0,
      background: `radial-gradient(ellipse at 50% 30%, ${p[0]}, ${p[1]})`
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
