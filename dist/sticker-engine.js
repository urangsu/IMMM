...
var IS_SAMSUNG_INTERNET = typeof navigator !== 'undefined' && /SamsungBrowser/i.test(navigator.userAgent || '');
var USE_TOUCH_FALLBACK = typeof window !== 'undefined' && (!('PointerEvent' in window) || IS_SAMSUNG_INTERNET);
...
function StickerCanvas({
  ...
  var renderStickerControls = (s, isSel) => {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      ...
      onPointerDown: USE_TOUCH_FALLBACK ? undefined : e => {
        e.stopPropagation();
        if (s.frameSlot != null) {
          unSnap(s.id);
          setSnapMode(false);
      ...
      onTouchStart: USE_TOUCH_FALLBACK ? e => {
        e.stopPropagation();
        if (s.frameSlot != null) {
          unSnap(s.id);
          setSnapMode(false);
  ...
  return /*#__PURE__*/React.createElement(SlottedStickersCtx.Provider, {
    ...
    onTouchStart: USE_TOUCH_FALLBACK ? () => {
      setSelectedId(null);
      setSnapMode(false);
    } : undefined,
    style: {
    ...
    var containerW = canvasW || width || 200;
    var containerH = height || 200;
    var metrics = resolveStickerFidelityMetrics(s, null, containerW, containerH);
    var raw = getStickerVisualBounds(s);
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: s.id,
      onPointerDown: USE_TOUCH_FALLBACK ? undefined : e => onPointerDown(e, s, 'move'),
      onTouchStart: USE_TOUCH_FALLBACK ? e => onPointerDown(e, s, 'move') : undefined,
...
function resolveStickerFidelityMetrics(sticker, geometry, containerWidth, containerHeight) {
  ...
  var rawSize = getStickerVisualBounds(sticker); // { w, h }

  var xPercent = 50;
  var yPercent = 50;
  var sizeNorm = sticker.sizeNorm || 0.16;
  if (isSlotted) {
  ...
  var widthPx = sizeNorm * containerWidth;
  var heightPx = widthPx * (rawSize.h / (rawSize.w || 1));
  var scale = sticker.scale || 1.0;
  return {
    xPercent,
    yPercent,
