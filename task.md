...
- [x] PR 1 — 문서/설계 초안
- [x] PR 2 — Desktop-only experimental skin_retouch shader compile validation
- [x] PR 3 — 실제 face mask 및 안정적인 hybrid(landmkar+skinColor) mask 구현
- [x] PR 4 — 필터별 strength 연결 (smooth 0.40 / blush 0.32 등)
