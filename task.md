...
- [ ] getFrameTemplateSafe exported from frame-system.jsx
- [ ] No post-frame-system file uses bare getFrameTemplate
- [ ] screens-edit legacy FrameThumb does not override frame-system FrameThumb
- [ ] Service Worker cache version bumped
- [ ] Service Worker uses network-first for html/js/jsx
