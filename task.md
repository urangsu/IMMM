...
- [ ] Galaxy S23+ 0.6× → 1× return verified
- [ ] Front camera zoom rail verified
- [ ] Rear camera zoom rail verified

---

## Galaxy Zoom Rail QA (Phase 3.43)
- [x] Debug zoom action history added
- [x] FOV proxy fields documented
- [x] normalCameraDeviceId visibility improved
- [x] 1× lens-return path remains guarded
- [x] fake 0.6× guard preserved
- [ ] Galaxy S23+ Chrome: 0.6× enter verified
- [ ] Galaxy S23+ Chrome: 1× return verified
- [ ] Galaxy S23+ Samsung Internet: 0.6× enter verified
- [ ] Galaxy S23+ Samsung Internet: 1× return verified
- [ ] Front camera zoom rail verified
- [ ] Rear camera zoom rail verified
