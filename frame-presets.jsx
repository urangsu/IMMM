...
const FRAME_PRESET_LAYOUT_SIZES = {
  get '1x4'() {
    const t = window.FRAME_TEMPLATES?.['1x4'];
    return t ? { width: t.canvasSize.width, height: t.canvasSize.height } : { width: 560, height: 1808 };
  },
  get '2x2'() {
    const t = window.FRAME_TEMPLATES?.['2x2'];
    return t ? { width: t.canvasSize.width, height: t.canvasSize.height } : { width: 880, height: 1096 };
  },
  get '1x3'() {
    const t = window.FRAME_TEMPLATES?.['1x3'];
    return t ? { width: t.canvasSize.width, height: t.canvasSize.height } : { width: 560, height: 1200 };
  },
  get '1x1'() {
    const t = window.FRAME_TEMPLATES?.['1x1'];
    return t ? { width: t.canvasSize.width, height: t.canvasSize.height } : { width: 880, height: 1070 };
  },
  get strip() { return this['1x4']; },
  get grid() { return this['2x2']; },
  get trip() { return this['1x3']; },
  get polaroid() { return this['1x1']; },
};
...
const FRAME_PRESET_LAYOUT_SLOTS = {
  get '1x4'() {
    const t = window.FRAME_TEMPLATES?.['1x4'];
    return t ? t.photoRects.map(r => ({ x: r.x, y: r.y, width: r.w, height: r.h, radius: 0.02 })) : [
  ...
  get '2x2'() {
    const t = window.FRAME_TEMPLATES?.['2x2'];
    return t ? t.photoRects.map(r => ({ x: r.x, y: r.y, width: r.w, height: r.h, radius: 0.03 })) : [
  ...
  get '1x1'() {
    const t = window.FRAME_TEMPLATES?.['1x1'];
    return t ? t.photoRects.map(r => ({ x: r.x, y: r.y, width: r.w, height: r.h, radius: 0.035 })) : [
