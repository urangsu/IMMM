...
const FILTERS = {
  ...
  smooth:    { name:'Cream Skin',   ko:'크림 스킨', css:'brightness(1.08) contrast(0.94) saturate(0.98) blur(0.12px)' },
  ...
  purikura:  { name:'Purikura',     ko:'프리쿠라',  css:'brightness(1.12) contrast(0.92) saturate(0.98) blur(0.14px)', overlay:'purikura', hidden:true },
